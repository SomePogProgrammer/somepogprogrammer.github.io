...
const ContactMe = () => {
  ...
  if (localStorage.getItem("Job_Request") != "null") {
    window.location = "#/JobRequests/" + localStorage.getItem("Job_Request")
  }
      ...
      <div className="contact-me-container01">
        ...
        <div className="contact-me-container03">
          <div className="contact-me-container04 flex justify-center">
            <svg viewBox="0 0 1024 1024" className="contact-me-icon04 w-10 h-10 md:w-16 md:h-16">
              <path d="M128 256h768v86h-768v-86zM128 554v-84h768v84h-768zM128 768v-86h768v86h-768z"></path>
            </svg>
            <svg viewBox="0 0 1024 1024" className="contact-me-icon06 w-10 h-10 md:w-16 md:h-16">
              <path d="M512 854q140 0 241-101t101-241-101-241-241-101-241 101-101 241 101 241 241 101zM512 86q176 0 301 125t125 301-125 301-301 125-301-125-125-301 125-301 301-125z"></path>
            </svg>
            <svg viewBox="0 0 1024 1024" className="contact-me-icon08 w-10 h-10 md:w-16 md:h-16">
        ...
        <div className="contact-me-container05">
          <form id="jobOfferForm" className="contact-me-container05" onSubmit={handleSubmit(onSubmit)} >
            ...
            <select {...register("contactType",{required: true})} required className="contact-me-select inputOnContactMe">
            ...
            <select {...register("jobType",{required: true})} required className="contact-me-select1_ inputOnContactMe">
            ...
            <select {...register("paymentMethod",{required: true})} required className="contact-me-select2 inputOnContactMe">
            ...
            <input type="submit" className="contact-me-send-offer-job button" value={"Send Offer"}></input>
          </form>
        ...
        <footer className="w-full">
          <div className="w-full md:w-3/5 md:ml-24">
            ...
            <h2 className="header-page-heading text-2xl md:text-4xl !bg-none">
              Want to Chat?<br />
              <span className="text-lg md:text-xl">Here are some of my other contacts</span>
            </h2>
