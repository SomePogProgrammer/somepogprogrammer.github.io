...
import "./scss/feature-card21.scss";

const FeatureCard21 = (propsTable) => {
  var props = Object.assign(FeatureCard21.customProps, propsTable)
  return (
...
export default memo(FeatureCard21);
