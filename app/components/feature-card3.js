...
import './scss/feature-card3.scss'

const FeatureCard3 = (propsTable) => {
  
  var props = Object.assign(FeatureCard3.customProps,propsTable)
  return (
...
export default memo(FeatureCard3);
